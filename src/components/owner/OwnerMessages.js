...
class OwnerMessagesInner extends Component{
    displayMessages = () =>{
        debugger;
        let orderDetails;
    ...
    sendOrderMessage = (evt) =>{
        ...
        let data = { "order_message": formData.get('message'), "order_id" : this.props.currentOrder, "sentBy": "owner" }
...
export const OwnerMessages = connect(mapStateToProps, mapDispatchToProps)(OwnerMessagesInner);
